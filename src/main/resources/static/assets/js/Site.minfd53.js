...
! function(global, factory) {
    if ("function" == typeof define && define.amd) define("/Site", ["exports", "jquery", "Config", "Base", "Menubar", "Sidebar", "PageAside", "GridMenu"], factory);
    else if ("undefined" != typeof exports) factory(exports, require("jquery"), require("Config"), require("Base"), require("Menubar"), require("Sidebar"), require("PageAside"), require("GridMenu"));
    else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.jQuery, global.Config, global.Base, global.SectionMenubar, global.SectionSidebar, global.SectionPageAside, global.SectionGridMenu), global.Site = mod.exports
    }
    ...
    var _jquery2 = babelHelpers.interopRequireDefault(_jquery),
        ...
        Site = function(_Base) {
            ...
            return babelHelpers.inherits(Site, _Base), babelHelpers.createClass(Site, [{
                ...
                key: "process",
                value: function() {
                    this.polyfillIEWidth(), this.initBootstrap(), this.setupMenubar(), this.setupFullScreen(), this.setupMegaNavbar(), this.setupWave(), this.setupTour(), this.setupNavbarCollpase(), this.setupGridMenu(), this.$el.on("click", ".dropdown-menu-media", function(e) {
                        e.stopPropagation()
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    $aside.length > 0 && (this.aside = new _PageAside2.default({
                        $el: $aside
                    }), this.aside.run()), this.menubar.run(), this.gridmenu.run()
                }
            }, {
                key: "setDefaultState",
                value: function() {
                ...
                key: "setupWave",
                value: function() {
                    "undefined" != typeof Waves && (Waves.init(), Waves.attach(".site-navbar .navbar-toolbar a", ["waves-light", "waves-round"]), Waves.attach(".btn", ["waves-classic"]))
                }
            }]), Site
        }(_Base3.default),
        instance = null;
