												...
												if (result[i][0].demandStatus == 'Finalised' && result[i][0].demandNoMaster.demandLevel == 'CMD') {
													...
													$('#databydemandno').append(
																	...
																	$("<tr>"
																			...
																			+ result[i][0].demandStatus
																			+ "</td>"
																			+ "<td><input class='form-control'  type='text' id='cmdApprovedQty' name='cmdApprovedQty' value='"
																			+ result[i][0].cmdApprovedQty
																			+ "'>"
																			+ "</td>"
																			+ "<td><textarea class='form-control' id='cmdRemarks' name='cmdRemarks'>"+ result[i][0].cmdRemarks+"</textarea>"
																			+ "</td>"
																			+
