...
! function(global, factory) {
    ...
    (0, _jquery2.default)(document).ready(function($) {
                ...
                options = _jquery2.default.extend(!0, {}, defaults, {
                    initComplete: function() {
                        this.api().columns().every(function() {
                            var column = this,
                                select = (0, _jquery2.default)('<select class="form-control width-full"><option value=""></option></select>').appendTo((0, _jquery2.default)(column.footer()).empty()).on("change", function() {
        ...
        (0, _jquery2.default)(document).ready(function() {
            ...
            (0, _jquery2.default)("#exampleTableTools1").dataTable(options)
        }),(0, _jquery2.default)(document).ready(function() {
            var defaults = Plugin.getDefaults("dataTable"),
            options = _jquery2.default.extend(!0, {}, defaults, {
                aoColumnDefs: [{
        ...
        (0, _jquery2.default)("#finalisedDemand").dataTable(options)
    }),
    (0, _jquery2.default)(document).ready(function() {
        var defaults = Plugin.getDefaults("dataTable"),
        options = _jquery2.default.extend(!0, {}, defaults, {
